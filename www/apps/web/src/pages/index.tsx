...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>Алексей Соколов - FrontEnd-разработчик и фотограф</title>
        <meta
          name="description"
          content="Привет! Меня зовут Соколов Алексей. Пишу софт и делаю графику."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            FrontEnd-разработчик и слегка фотограф :)
          </h1>
