...
function LinkIcon(props: React.SVGAttributes<SVGSVGElement>) {
  return (
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Проект - Алексей Соколов</title>
        <meta name="description" content="Проект - Алексей Соколов" />
      </Head>
      <SimpleLayout
        title="Проекты, которые я сделал в надежде, что кто-то ими будет пользоваться..."
          ...
          {projects.map(project => (
            <Card as="li" key={project.name}>
              <div
               ...
               justify-center rounded-full bg-white shadow-md shadow-zinc-800/5
                ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 
              ...
              group-hover:text-orange-500 dark:text-zinc-200"
              >
